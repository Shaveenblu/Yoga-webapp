        ...
        <div className='px-4 py-4 flex items-center justify-between'>
            ...
            <div onClick={() => navigate('/')} className='flex-shrink-0 cursor-pointer pl-7 md:p-0 flex items-center'>
              ...
              <h1 className='text-2xl inline-flex gap-3 items-center font-bold'>YogaMaster
               <img src='/yoga-logo.png' alt='' className='w-8 h-8'/></h1>
              <p className='font-bold text-[13px] tracking-[8px]'>Quick Explorer</p>
              </div>
            </div>
            ...
            <div className='hidden md:block text-black dark:text-white'>
              <div className='flex'>
                <ul className='ml-10 flex items-center space-x-4 pr-4'>
                  ...
                  {
                    user && <li>
                      <img src={photoURL} alt='' className='h-[40px] rounded-full
                      w-[40px]'/>
                    </li>
                  }
